...
@section('content')
    ...
    <form action="" method="POST">
        <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" placeholder="Tên người dùng..." value="{{old('name')}}">
            @error('name')
        ...
        <div class="form-group">
            ...
            <input type="text" name="email" class="form-control" placeholder="Email người dùng..." value="{{old('email')}}">
            @error('email')
                <span style="color: red">{{$message}}</span>
            @enderror
        </div>
